...
void SPI1_ini ()
{
	...
	SPI1_Init.SPI_BaudRatePrescaler = SPI_BaudRatePrescaler_16; //зададим делитель частоты шины
...
void SPI2_ini ()
{
	...
	GPIO_ini_SPI2.GPIO_Pin = GPIO_Pin_13 | GPIO_Pin_14 | GPIO_Pin_15; //выберем пин 13, 15 порта B для настройки
