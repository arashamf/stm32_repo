...
void init_MAX7219 ()
{
	...
	send_data_displey (display1, reg_Intensity, 0x2);
	send_data_displey (display2, reg_Intensity, 0x2);
	send_data_displey (display3, reg_Intensity, 0x2);
	send_data_displey (display4, reg_Intensity, 0x2);
...
void putchar_display (uint8_t number_display, uint8_t first_registr_string, uint8_t *numb)
{
	for (uint8_t count = 0; count < 8; count++)
		{
		send_data_displey (number_display, (first_registr_string + count), *numb++);
		}
