...
void ini_TIMER4_beep ()
{
	...
	TIM4_ini.TIM_Prescaler = 48000 - 1; //предделитель
	TIM4_ini.TIM_CounterMode = TIM_CounterMode_Up; //счёт на увеличение
	TIM4_ini.TIM_Period = 10000 - 1;  //значение перезагрузки
	...
	SET_BIT (TIM4->SMCR, (TIM_SMCR_SMS_2 | TIM_SMCR_SMS_1));
